...
configurazione devono essere opportunamente duplicati e rinominati in
\texttt{.env} (o nelle relative estensioni specifiche) in base
all'ambiente di esecuzione target, avendo cura di compilare i campi
relativi alle chiavi segrete di Supabase e alle porte di
comunicazione del proxy Nginx.
